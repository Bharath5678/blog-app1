    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-column">
          ...
          <p>
            A modern blogging platform with a clean design, responsive layout, and dark mode support. Create and share your stories with the world.
          </p>
        ...
        <div className="footer-column">
          ...
          <Link to="/category/food">Food & Cooking</Link>
          <Link to="/category/health">Health & Fitness</Link>
        </div>
